...
outputOptions = {'tau','Qh','Qe','C_DN','C_EN',...
     ...
     'uSt_a','uSt_aN','Evap','wTemp','Qsr','obu'};
  
% writable outputs
programOptions= {'openWtr','openWnd','openWnd','openRH',...
    'openAirT','openSW','dwnSmple','senslatYes'};
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_tau',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','tau (N m^{-2})',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_Qh',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','Qh (W m^{-2})',...
...
RunAxes.(char(name)) = struct('YLabel','C_D10N',...
...
RunAxes.(char(name)) = struct('YLabel','C_E10N',...
...
RunAxes.(char(name)) = struct('YLabel','C_H10N',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_C_D',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','C_D',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_C_E',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','C_E',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_C_H',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','C_H',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_C_D10',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','C_D10',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_C_E10',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','C_E10',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_C_H10',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','C_H10',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_t10',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','^\circ{C}',...
    'Title','Air temperature at 10 m');

% Long wave heat flux
name = 'Qlnet';
RunNeed.(char(name)) = {'openRH','openAirT','openWtr','openSW','wrt_Qlnet'};
RunAxes.(char(name)) = struct('YLabel','W m^{-2}',...
    'Title','Net long wave heat radiation');

% Incoming long wave radiation
name = 'Qlin';
RunNeed.(char(name)) = {'openRH','openAirT','openWtr','openSW','wrt_Qlin'};
RunAxes.(char(name)) = struct('YLabel','W m^{-2}',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_uSt_a',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','u^{*}_{a}',...
    'Title','Air shear velocity');

% Air shear velocity
name = 'uSt_aN';
RunNeed.(char(name)) = {'openWnd','wrt_uSt_aN'};
RunAxes.(char(name)) = struct('YLabel','u^{*}_{aN}',...
...
RunNeed.(char(name)) = {'openWtr','openWnd','openRH','openAirT','wrt_obu',...
    'senslatYes'};
RunAxes.(char(name)) = struct('YLabel','Lw',...
    'Title','Monin-Obukhov length scale');
